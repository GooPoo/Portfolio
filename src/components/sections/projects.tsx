...
const ProjectCard = ({ project }: { project: projectType }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex h-[35rem] w-80 flex-col overflow-hidden rounded-md border p-3 shadow-lg md:h-[32rem] md:w-[30rem]"
    >
      <div className="h-52">
        <Image
          src={project.img}
...
const Projects = () => {
  return (
    <MaxWidthWrapper className="flex flex-col pb-20">
      ...
      >
        I&apos;ve worked on a diverse range of projects, spanning from simple web applications to
        sophisticated implemenations of machine learning algorithms. Here are a few of my favorites.
      </motion.p>
